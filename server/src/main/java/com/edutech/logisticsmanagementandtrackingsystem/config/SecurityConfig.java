...
// .antMatchers(HttpMethod.POST, "/api/business/cargo",
// "/api/business/assign-cargo").hasRole("BUSINESS")
// .antMatchers(HttpMethod.GET, "/api/business/drivers", "/api/business/cargo",
// "/business/cargo-id").hasRole("BUSINESS")

// // DRIVER role endpoints
// .antMatchers(HttpMethod.GET, "/api/driver/cargo").hasRole("DRIVER")
// .antMatchers(HttpMethod.PUT,
// "/api/driver/update-cargo-status").hasRole("DRIVER")

// // CUSTOMER role endpoints
// .antMatchers(HttpMethod.GET,
// "/api/customer/cargo-status").hasRole("CUSTOMER")
